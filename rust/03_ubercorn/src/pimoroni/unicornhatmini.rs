...
use tokio::{sync::watch::{Receiver, channel}, task::JoinHandle};
use std::{io::Write, ops::Range, time::{Duration, SystemTime}};
...
impl UnicornHatMini {
    pub fn new() -> Self {
        ...
        let button_join_handle: JoinHandle<()> = tokio::task::spawn_blocking(move || {
            ...
            loop {
                ...
                if elapsed > Duration::new(0, 500000000) {
    ...
    pub fn set_xy(&mut self, x: usize, y: usize, r: u8, g: u8, b: u8) {
        let idx = x*7 + y;
    ...
    pub fn set_idx(&mut self, idx: usize, r: u8, g: u8, b: u8) {
